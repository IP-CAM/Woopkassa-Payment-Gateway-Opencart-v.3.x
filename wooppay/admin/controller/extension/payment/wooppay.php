...
class ControllerExtensionPaymentWooppay extends Controller
{
	...
	public function index()
	{
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/payment/wooppay', 'user_token=' . $this->session->data['user_token'], 'SSL'),
			'separator' => ' :: '
		);

		$data['form_submit'] = $this->url->link('extension/payment/wooppay', 'user_token=' . $this->session->data['user_token'], 'SSL');
